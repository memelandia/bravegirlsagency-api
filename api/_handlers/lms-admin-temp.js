...
async function handleModules(req, res, user) {
  ...
  if (req.method === 'POST') {
    ...
    return res.status(200).json({ module: result.rows[0] }, 201);
  }
...
async function handleLessons(req, res, user) {
  ...
  if (req.method === 'POST') {
    ...
    return res.status(200).json({ lesson: result.rows[0] }, 201);
  }
...
async function handleQuestions(req, res, user) {
  ...
  if (req.method === 'POST') {
    ...
    return res.status(200).json({ question: result.rows[0] }, 201);
  }
...
async function handleStages(req, res, user) {
  ...
  if (req.method === 'POST') {
    ...
    return res.status(200).json({ stage: result.rows[0] }, 201);
  }
...
async function handleQuizzes(req, res, user) {
  ...
  if (req.method === 'POST') {
    ...
    return res.status(200).json({ quiz: result.rows[0] }, 201);
  }
