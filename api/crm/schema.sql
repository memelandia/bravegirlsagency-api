-- CRM Database Schema
-- Para usar en Vercel Postgres, Supabase, o cualquier PostgreSQL
...
CREATE UNIQUE INDEX idx_crm_assignments_unique ON crm_assignments(chatter_id, model_id, estado) WHERE estado = 'activa';
...
-- Unique constraint para plataforma + handle
CREATE UNIQUE INDEX idx_crm_social_accounts_unique ON crm_social_accounts(plataforma, handle);
...
CREATE TRIGGER update_crm_models_updated_at BEFORE UPDATE ON crm_models FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_crm_chatters_updated_at BEFORE UPDATE ON crm_chatters FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_crm_assignments_updated_at BEFORE UPDATE ON crm_assignments FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_crm_social_accounts_updated_at BEFORE UPDATE ON crm_social_accounts FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_crm_supervisors_updated_at BEFORE UPDATE ON crm_supervisors FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_crm_staff_updated_at BEFORE UPDATE ON crm_staff FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
