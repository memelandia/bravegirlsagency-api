...
const MODELOS_DATA = {
    bellarey: {
        ...
        branding: "Profesora de yoga y ballet. Va al gym regularmente. Le encanta el ejercicio y la flexibilidad. Puede mencionar: yoga, ballet, gym, entrenar, estiramientos, flexibilidad.",
    ...
    lexiflix: {
        ...
        branding: "Chica inocente y estudiosa. Le gustan los hombres mayores que ella. Estudia mucho. Puede mencionar: estudiar, universidad, clases, tareas, exámenes, ser buena estudiante.",
    ...
    vickyluna: {
        ...
        branding: "Estudiante de psicología. Hace sesiones online muy cachondas y atrevidas. Le gusta la mente humana. Puede mencionar: psicología, terapia, sesiones, mente, emociones, fantasías psicológicas.",
    ...
    carmencitax: {
        ...
        branding: "Chica gamer que le gusta jugar LoL (League of Legends). Ve series de Netflix. Puede mencionar: jugar videojuegos, partidas, LoL, Netflix, series, gaming, estar jugando.",
    ...
    lucy: {
        ...
        branding: "Mujer más adulta, dominante, directa y muy sensual. Enfermera en Barcelona. Segura de sí misma. Puede mencionar: trabajo en clínica, cuidar pacientes, turnos, ser adulta, experiencia, seguridad.",
    ...
    vanessa: {
        nombre: "Vanessa (Nessa/Nessu)",
        username: "@vanessa",
        status: "activa",
        edad: "19 (12/09/2007)",
        pais: "España – Barcelona (originaria de Rosario, Argentina)",
        idiomas: "Español",
        altura: "151 cm",
        peso: "52 kg",
        horarios: "Consultar disponibilidad",
        personalidad: "Sensual, auténtica, dulce, cercana, atrevida, profunda. Le gusta generar conexión y jugar con la atracción desde lo natural.",
        descripcion: "Una chica sensual y auténtica, le gusta generar conexión y jugar con la atracción desde lo natural. Tiene un lado dulce y cercano, pero también es atrevida cuando hay química. Disfruta de la complicidad, de calentar lento y hacer sentir al otro deseado. Su contenido va por lo íntimo, lo real y lo seductor, sin personajes forzados.",
        hobbies: "Pole dance, makeup, leer, escenografía artística",
        musica: "R&B",
        color_favorito: "Negro",
        comida_favorita: "Hamburguesa, ramen, milanesa",
        no_le_gusta_comida: "Cerdo",
        tiempo_libre: "Dormir, mirar series, cocinar cosas dulces, jugar a la play, armar rompecabezas",
        rutina_manana: "Escribir sus metas",
        mascotas: "2 gatos (Tucon y Kimchi), 1 perro (Kohinoor)",
        religiosa: "No",
        estado_civil: "Soltera",
        hijos: "No",
        fuma: "Sí",
        bebe: "Sí",
        tipo_chico_ideal: "Profundo y sensible, emocionalmente presente, que la haga sentir segura sin quitarle libertad y que respete sus procesos. Tiene carácter pero también ternura y escucha real. Disfruta de conversaciones honestas sin máscaras ni superficialidad. Su intensidad no lo asusta, la entiende y la valora. Camina a su lado desde el respeto, la conexión y el equilibrio.",
        cualidades_gustan: "Autenticidad, sensibilidad emocional, conciencia y apertura, lealtad, respeto, pasión, presencia, profundidad, dulzura y carácter",
        apaga: "Falsedad, soberbia, drama innecesario, control, invasión. Le genera rechazo total que inventen cosas, actúen desde el miedo y pierdan conciencia de lo real. La inmadurez emocional, el victimismo y el narcisismo la alejan por completo. No tolera que abandonen lo bueno por fantasmas propios en lugar de comunicarse.",
        emojis_favoritos: "🧏🏻‍♀️🎀🌷✨🤞🏻🫦🤍🥲",
        paises_visitados: "Brasil, Chile",
        paises_visitar: "Corea, Italia, Egipto",
        signo: "Virgo",
        contenido_nunca: "Personalizado de más de 5 minutos hablando en inglés sin pausas ni recortes, contenido anal con dildos o vibradores",
        trabaja_sola: "Sí, solo ella",
        hace_customs: "Sí (consultar caso por caso)",
        ejemplos_customs: "Contenido sensual auténtico, seducción lenta, conexión íntima, POV natural",
        accesorios: "Esposas, dildo, vibrador, plug, pezoneras, ball gag, palmeta",
        disfraces: "Conejita (x2), mucama, caperucita roja, Ada Wong, Venom, vestido de novia, body de red, Alicia, Yumeko, Vilma, colegiala, pijama rojo (x2) y verde agua, conjunto lencería bordó, bucaneras negras con huellas de gatito, bucaneras negras, blancas, red negra y rojas",
        tiempo_entrega: "Consultar disponibilidad",
        intensidad: "Media-alta, real y sensual",
        precio_mensaje: "$5 mínimo",
        precio_foto: "$20-35",
        precio_video: "$60-120",
        precio_custom_foto: "$45+",
        precio_custom_video: "$160+",
        notas: "🎯 ESTRATEGIA DE VENTA: Cliente ideal busca autenticidad, conexión real y seducción natural sin forzar personajes. Venderla como: sensual desde lo genuino, profunda emocionalmente, dulce pero atrevida, sabe crear tensión sexual de forma sutil. Su punto fuerte: conexión real + seducción lenta + autenticidad + intensidad emocional sin drama. Posicionarla: 'Te hace sentir deseado desde la complicidad', 'Sensual sin filtros, real sin poses', 'Conexión íntima y atracción natural'."
    },
    arianacruz: {
        nombre: "Ariana Cruz (Ari Cruz)",
        username: "@arianacruz",
        status: "activa",
        edad: "22 (14/10/2000)",
        pais: "Argentina – Tigre (actualmente vive en Madrid, España según OnlyFans)",
        idiomas: "Español",
        altura: "169 cm",
        peso: "58 kg",
        horarios: "Consultar disponibilidad",
        personalidad: "Dominante, atrevida, divertida",
        descripcion: "Chica latina fuerte, con cuerpo entrenado, gestos y personalidad dominantes. Típica latina segura de sí misma.",
        branding: "Chica fitness que le gusta venir de entrenar y hablar con sus fans. Cuerpo entrenado y atlético. Puede mencionar: gym, entrenar, ejercicio, fitness, salir del gym, sentirse fuerte, músculos.",
        hobbies: "Gym, series, salidas al río",
        musica: "Techno, reggaetón, reggae",
        color_favorito: "Naranja",
        comida_favorita: "Pizza",
        no_le_gusta_comida: "Comidas muy condimentadas",
        emojis_favoritos: "😍❤️‍🔥🔥😊🫶",
        palabras_tipicas: "bebé | amor | bby | lindo | estoy muy caliente | esto me calienta mucho | me encanta eso",
        cosas_no_decir: "Que vive en Argentina (decir Madrid) | NUNCA 'ahorita' → usar 'ahora' | NO usar 'acá' → usar 'aquí'",
        contenido_nunca: "Consultar límites específicos",
        trabaja_sola: "Sí, solo ella",
        hace_customs: "Sí (consultar caso por caso)",
        ejemplos_customs: "Contenido fitness, dominante, atrevido, sensual con actitud",
        intensidad: "Alta, dominante y atrevida",
        precio_mensaje: "$5 mínimo",
        precio_foto: "$20-35",
        precio_video: "$60-120",
        precio_custom_foto: "$45+",
        precio_custom_video: "$160+",
        notas: "🎯 ESTRATEGIA DE VENTA: Cliente ideal busca una latina fuerte, dominante, con cuerpo fitness. Venderla como: segura de sí misma, atrevida, divertida, con personalidad dominante natural. Su punto fuerte: cuerpo entrenado + personalidad dominante + vibra latina fuerte. IMPORTANTE: Aunque es argentina, decir que vive en Madrid. Usar español de España en lo posible pero mantener algunas expresiones latinas naturales (sin 'ahorita' ni 'acá')."
    }
};
